            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="collapsibleNavbar">
                  <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                      <a class="nav-link text-light" href="wip.html"><b>Employees</b></a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link text-light active" href="wip.html">Utilities</a>
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="wip.html">Log Out</a>
                        </div>
                    </li>
                  </ul>
                </div>
